...
const uploadFootwear = () => {
    ...
    const fetchCosmetics = async () => {
        try {
            ...
            const response = await axios.get("http://localhost:9090/admin/footwear", {
                headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post("http://localhost:9090/admin/upload/footwear", formData, {
                headers: {
    ...
    const handleDelete = async (id) => {
        const token = localStorage.getItem("token");
        try {
            await axios.delete(`http://localhost:9090/admin/delete/footwear/${id}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
    ...
    const handleEdit = async (e) => {
        ...
        try {
            const response = await axios.put(
                `http://localhost:9090/admin/update/footwear/${selectedCosmetic.id}`,
                formData,
                {
                    headers: {
                        "Content-Type": "multipart/form-data",
