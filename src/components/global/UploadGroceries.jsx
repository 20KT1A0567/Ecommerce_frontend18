...
>>>>>>> 22eeded14a52fadc998509d10f58b7931440ecf9
    const fetchCosmetics = async () => {
        try {
            ...
            const response = await axios.get("http://localhost:9090/admin/grocery", {
                headers: {
...
>>>>>>> 22eeded14a52fadc998509d10f58b7931440ecf9
        ...
        try {
            await axios.post("http://localhost:9090/admin/upload/grocery", formData, {
                headers: {
...
>>>>>>> 22eeded14a52fadc998509d10f58b7931440ecf9
    const handleDelete = async (id) => {
        const token = localStorage.getItem("token");
        try {
            await axios.delete(`http://localhost:9090/admin/delete/grocery/${id}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
    ...
    const handleEdit = async (e) => {
        ...
        try {
            const response = await axios.put(
                `http://localhost:9090/admin/update/grocery/${selectedCosmetic.id}`,
                formData,
                {
                    headers: {
                        "Content-Type": "multipart/form-data",
