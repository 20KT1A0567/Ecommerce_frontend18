...
>>>>>>> 22eeded14a52fadc998509d10f58b7931440ecf9
    const fetchCosmetics = async () => {
        try {
            ...
            const response = await axios.get("http://localhost:9090/admin/mobiles", {
                headers: {
...
>>>>>>> 22eeded14a52fadc998509d10f58b7931440ecf9
        ...
        try {
            await axios.post("http://localhost:9090/admin/upload/mobiles", formData, {
                headers: {
    ...
    const handleEdit = async (e) => {
        ...
        try {
            const response = await axios.put(
                `http://localhost:9090/admin/update/mobiles/${selectedCosmetic.id}`,
                formData,
                {
                    headers: {
                        "Content-Type": "multipart/form-data",
